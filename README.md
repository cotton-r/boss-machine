...
Project was sourced by CodeCademy.com

An entire API to serve information to a 'Boss Machine', a unique management application for today's most accomplished (evil) entrepreneurs. I have created routes to manage my 'minions', my 'million dollar ideas', and to handle all of the meetings that keep getting added to my schedule.
...
For some reason, the only way to get the project running is to open the 'index.html' file in your browser, after doing the above 'npm run start' command. This should then allow the project to run successfully.

You should use [Google Chrome] (at least version 60) or [Firefox] (at least version 55). 

### The Instructions I Was Given For The Project:
